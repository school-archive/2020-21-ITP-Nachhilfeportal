    ...
    <div>
      <div class="profile">
        ...
        <div class="info">
          ...
          <h1>{{ this.profile_data.first_name }} {{ this.profile_data.last_name }}</h1>
          <p class="text">{{ this.profile_data.department || 'Keine Abteilung gesetzt' }}</p>
          <span class="grey">{{ this.profile_data.grade ? `${this.profile_data.grade}. Klasse` : 'Keine Klasse gesetzt'}}</span><br><br>
